...
This API allows you to manipulate and control the browser's animation engine that was previously only accessible through CSS.
...
It is definitely usable with React, Svelte or other web libraries.
In fact, I'm using it with Svelte on this blog.
...
Motion One is more aimed at the new wave of web libraries like Vue and Solid.
...
Additionally, if you're curious about the comparison between Motion One and Framer Motion, you should definitely give [this article](https://motion.dev/blog/should-you-use-framer-motion-or-motion-one) a read.
